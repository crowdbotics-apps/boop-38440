"""
Django settings for boop_38440 project.
...
WSGI_APPLICATION = 'boop_38440.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "boop_38440 API",
    "DESCRIPTION": "API documentation for boop_38440 App",
    "VERSION": "v1",
}
